...
// Use products from data file for featured list (IDs in the order you provided)
const featuredIds = [1, 4, 7, 10, 8, 9];
...
export default function Home() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-5xl md:text-6xl font-bold uppercase mb-4 leading-tight">
                ...
                Momentos
                <br />
                <span className="text-accent-foreground drop-shadow-lg">Perfeitos</span>
              </h1>
              <p className="text-lg mb-6 font-mono opacity-90">
                Câmeras, lentes e acessórios fotográficos de qualidade profissional para seus projetos.
              </p>
  ...
  {/* Seção de Categorias */}
      <section className="py-12 md:py-16 bg-background">
        <div className="container">
          <h2 className="text-4xl font-bold uppercase mb-8 text-center">Categorias</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {categories.map((cat) => (
              <Link key={cat.name} href={`/categoria/${cat.name.toLowerCase()}`}>
                <div className="retro-card hover:shadow-lg transition cursor-pointer group">
                  <div className="mb-4 text-center group-hover:scale-110 transition">
                    <CategoryIcon category={cat.name} className="w-12 h-12 mx-auto" />
                  </div>
                  <h3 className="text-lg font-bold uppercase text-center mb-2">{cat.name}</h3>
                  <p className="text-sm text-center text-muted-foreground">{cat.count} produtos</p>
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="py-12 md:py-16 bg-card">
        <div className="container">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-4xl font-bold uppercase">Produtos em Destaque</h2>
            <Link href="/catalogo">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredProducts.map((product) => (
              <div key={product.id} className="retro-card group hover:shadow-xl transition">
                {/* Selo */}
                {product.badge && (
                ...
                <div className="flex gap-2">
                  <button className="flex-1 retro-button flex items-center justify-center gap-2 text-sm">
      ...
      <section className="py-12 md:py-16 bg-accent text-accent-foreground retro-pattern">
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-4xl font-bold uppercase mb-4">Fique por Dentro</h2>
        ...
        <div className="container">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="retro-card text-center">
              <div className="mb-4">
                <ShippingIcon className="w-12 h-12 mx-auto" />
              </div>
            ...
            <div className="retro-card text-center">
              <div className="mb-4">
                <SecureIcon className="w-12 h-12 mx-auto" />
              </div>
              <h3 className="text-lg font-bold uppercase mb-2">Compra Segura</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="retro-card text-center">
              <div className="mb-4">
                <ReturnIcon className="w-12 h-12 mx-auto" />
              </div>
              <h3 className="text-lg font-bold uppercase mb-2">Devolução Fácil</h3>
              <p className="text-sm text-muted-foreground">
